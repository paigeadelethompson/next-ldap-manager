    ...
    async function fetchEntry() {
      try {
        ...
        setEntry({
          ...
          attributes: {
            cn: decodeURIComponent(resolvedParams.dn.split(',')[0].replace('cn=', '')),
      ...
      <main className="max-w-2xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <Card title="Edit Entry">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <FormField label="Distinguished Name" description="Cannot be changed">
        ...
        <Card className="mt-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Raw Attributes</h3>
